...
var CurveAnim = inherit(function(curve, curveSet) {
    ...
    drawCurveExit: function() {
        ...
        if (0 === curve.points.length) {
            ...
            alpha = alpha * (1 - (this.time - DEFAULT_ANIMATION_LENGTH) / DEFAULT_ANIMATION_LENGTH);
            this.time += 1;
        }
        else {
...
var SloganAnim = inherit(function() {}, AnimationClass, {
    data: {
...
var TransactionAnim = inherit(function(txn) {
    this.data = txn;
}, AnimationClass, {
    draw: function() {
